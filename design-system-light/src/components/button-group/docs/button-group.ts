 ...
 */
export const ButtonGroup = ({vertical, slotContent}: ButtonGroupProps) => {
  return html`
	<sy-button-group
    ?vertical=${vertical}>
  <sy-button variant="default">Button 1</sy-button>
  <sy-button variant="default">Button 2</sy-button>
  <sy-button variant="default">Button 3</sy-button>
</sy-button-group>
  `;
};
