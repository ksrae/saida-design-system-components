...
export const SplitPanel = ({ disabled, hideDivider, minRatio, ratio, type }: SySplitPanelProps) => html`
  ...
  >
    <div slot="left" style="background:#e0f0ff;padding:12px;">Panel A</div>
    <div slot="right" style="background:#ffe0e0;padding:12px;">Panel B</div>
  </sy-split-panel>
`;

export const SplitPanelDisabled = (a: { disabled: boolean }) => html`
  <sy-split-panel ?disabled=${!!a.disabled} style="height:200px;border:1px solid #ccc;">
    <div slot="left" style="background:#e0f0ff;padding:12px;">Panel A</div>
    <div slot="right" style="background:#ffe0e0;padding:12px;">Panel B</div>
  </sy-split-panel>
`;
export const SplitPanelHideDivider = (a: { hideDivider: boolean }) => html`
  <sy-split-panel .hideDivider=${a.hideDivider} style="height:200px;border:1px solid #ccc;">
    <div slot="left" style="background:#e0f0ff;padding:12px;">Panel A</div>
    <div slot="right" style="background:#ffe0e0;padding:12px;">Panel B</div>
  </sy-split-panel>
`;
export const SplitPanelMinRatio = (a: { minRatio: number }) => html`
  <sy-split-panel .minRatio=${a.minRatio} style="height:200px;border:1px solid #ccc;">
    <div slot="left" style="background:#e0f0ff;padding:12px;">Panel A</div>
    <div slot="right" style="background:#ffe0e0;padding:12px;">Panel B</div>
  </sy-split-panel>
`;
export const SplitPanelRatio = (a: { ratio: number }) => html`
  <sy-split-panel ratio=${ifDefined(a.ratio as any)} style="height:200px;border:1px solid #ccc;">
    <div slot="left" style="background:#e0f0ff;padding:12px;">Panel A</div>
    <div slot="right" style="background:#ffe0e0;padding:12px;">Panel B</div>
  </sy-split-panel>
`;
export const SplitPanelType        = (a: { type: 'horizontal' | 'vertical' }) =>
  html`
    <sy-split-panel type=${ifDefined(a.type)} style="height:200px;border:1px solid #ccc;">
      <div slot="left" style="background:#e0f0ff;padding:12px;">Panel A</div>
      <div slot="right" style="background:#ffe0e0;padding:12px;">Panel B</div>
    </sy-split-panel>
  `;
...
export const SplitPanelHorizontalChanged = () => {
  ...
  return html`
    <sy-split-panel type="horizontal" style="height:200px;border:1px solid #ccc;" @horizontalChanged=${handle}>
      <div slot="left" style="background:#e0f0ff;padding:12px;">A</div>
      <div slot="right" style="background:#ffe0e0;padding:12px;">B</div>
    </sy-split-panel>
