...
export const Datepicker = ({mode, variant, year, month, day, hour, minute, second, dateNames, disabled, readonly, mondayStart, hideWeekend, placeholder, format} : SyDatepickerProps) => {
	return html`
		<sy-datepicker
			mode="${mode}"
			variant="${variant}"
