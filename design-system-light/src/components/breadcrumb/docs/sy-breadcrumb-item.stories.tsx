...
import { SyBreadcrumbItemprops, BreadCrumbItem } from './sy-breadcrumb.main';
import { clearElements } from '../../clear-element';

const breadcrumbItemMeta: Meta<SyBreadcrumbItemprops> = {
  title: 'Breadcrumb-Item/Overview',
  component: 'sy-breadcrumb-item',
  tags: [],
  render: (args) => {
    clearElements(breadcrumbItemMeta.title);
  ...
  argTypes: {
   active: {
    ...
    slot: {
      control: 'text',
      description: 'Value of the breadcrummb item',
      table: {
        category: 'Parameter',
...
type Story = StoryObj<SyBreadcrumbItemprops>;
