...
export const Icon = ({path, selectable, size, slotContent}: IconProps) => {
  return html`
	<sy-icon
    path=${path}
...
// export const IconVariant = (args: {variant: 'solid' | 'regular'}) => {
//   return html`
// <sy-icon variant=${args.variant} type="alarm-clock"></sy-icon>
// `;
// }
