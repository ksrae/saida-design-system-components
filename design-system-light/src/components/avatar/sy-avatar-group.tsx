...
export class SyAvatarGroup {
  ...
  disconnectedCallback() {
    ...
    // cleanup any appended dropdown container
  ...
  private handleEnterMoreAvatar() {
    ...
    container.addEventListener('mouseleave', () => { this.isHovering = false; this.handleLeaveMoreAvatar(); });
  }
    ...
    setTimeout(() => {
      if (!this.isHovering) {
        ...
        if (container) {
          ...
          try { document.body.removeChild(container); this.host.appendChild(container); } catch (e) {}
        }
      }
    }, 100);
  }
