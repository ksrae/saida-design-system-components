...
export const Avatar = ({ clickable, disabled, icon, image, letter, size, text, tooltipContent, variant } : SyAvatarProps) => {
  return html`
    <sy-avatar-group>
      <sy-avatar
        ?clickable=${clickable}
  ...
  export const AvatarGroup = ({ clickable, maxCount, size, variant, slot } : SyAvatarGroupProps) => {
    return html`
    <sy-avatar-group
      ?clickable=${clickable}
      maxCount=${maxCount}
